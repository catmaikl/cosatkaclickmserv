  ...
  try {
    ...
    server.listen(PORT, async () => {
      ...
      try {
        ...
        currentGlobalEvent = await GlobalEvent.findOne({ active: true }).maxTimeMS(5000);
        ...
        console.error('Error initializing global events:', err);
        await createGlobalEvent(); // Fallback to creating new event
      }
    });
  } catch (err) {
