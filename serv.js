...
socket.on('player-join', (playerData) => {
    ...
    const player = {
        ...
        currentSkin: playerData.currentSkin || 'default', // Добавляем скин
        ownedSkins: playerData.ownedSkins || ['default'] // Добавляем список скинов
    };
...
socket.on('skin-change', (data) => {
    ...
    if (player) {
        ...
        // Уведомляем других игроков о смене скина
